# Privacy Policy — WheelOfMovie

**Last updated:** May 30, 2026

This Privacy Policy describes how WheelOfMovie ("we", "our", or "the app") handles your information. We believe privacy is a right, so this policy is intentionally simple: we do not collect, share, or sell your personal data.

---

## 1. Overview

WheelOfMovie is a movie-picker app that lets you build a personal watchlist and spin a wheel to choose what to watch next. All data you create in the app stays on your device. We do not operate any servers, create any user accounts, or store any information about you remotely.
...
This data never leaves your device except as described in Section 4 below. You can delete all of it at any time from within the app, or by uninstalling WheelOfMovie.
...
WheelOfMovie uses no third-party analytics, advertising, or crash-reporting SDKs. The app is built entirely on Apple's native frameworks (UIKit, CoreData, CoreHaptics, Metal). There are no CocoaPods, SPM packages, or external libraries integrated.
...
WheelOfMovie does not knowingly collect any information from children under the age of 13 (or the applicable age of digital consent in your jurisdiction). The app collects no personal data from anyone, making it safe for all ages.
...
- **Remove all app data**: Uninstall WheelOfMovie from your device. This permanently removes all CoreData and UserDefaults entries associated with the app.

---

## 9. Changes to This Policy

If this policy changes materially, we will update the "Last updated" date at the top of this document and, where appropriate, notify users through an app update. Continued use of WheelOfMovie after a policy change constitutes acceptance of the updated terms.
...
*WheelOfMovie is an independent app. The movie data and poster images displayed in search results are provided by a third-party API and sourced from publicly available movie databases.*
